...
function enviarTermoPorEmail($caminhoCompleto, $destinatario,$nome = '', $patrimonio = '' )
{
  ...
  try {
    ...
    $patrimonioLimpo = preg_replace('/[^0-9]/', '', $patrimonio);
    $nomeArquivo = 'Termo_' . $nomeLimpo . '_' . $patrimonioLimpo . '.pdf';

    // Anexo
    $mail->addAttachment($caminhoCompleto, 'Termo_' . $nome . '_' . $patrimonio . '.pdf');

    // Conteúdo do e-mail
    $mail->isHTML(true);
    $mail->Subject = 'Termo de Responsabilidade - Equipamento';
    $mail->Body = "
  <div style='font-family: Arial, sans-serif; font-size: 15px;'>
    <p>Olá $nome,</p>

    <p>Segue anexo o <strong>Termo de Responsabilidade</strong> referente ao seguinte colaborador:</p>
