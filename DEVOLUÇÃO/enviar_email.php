...
function enviarTermoPorEmail($caminhoCompleto, $destinatario, $nome = '', $patrimonio = '')
{
  ...
  try {
   ...
   $nomeArquivo = 'Termo_' . $nomeLimpo . '_' . $patrimonioLimpo . '.pdf';
    ...
    // Anexo
    $mail->addAttachment($caminhoCompleto, 'Termo_Devolução_' . $nome . '_' . $patrimonio . '.pdf');

    // Conteúdo do e-mail
    $mail->isHTML(true);
    $mail->Subject = 'Termo de Devolução - Equipamento';
    $mail->Body = "
  <div style='font-family: Arial, sans-serif; font-size: 15px;'>
    <p>Olá $nome,</p>

    <p>Segue anexo o <strong>Termo de Devolução</strong> referente ao seguinte colaborador:</p>
