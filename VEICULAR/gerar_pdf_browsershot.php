...
try {
   ...
   $resultadoEmailFixo = enviarTermoPorEmail($caminhoCompleto, 'suporte.ti@udlog.com.br', $nome );

// Envia o PDF para o colaborador, se o e-mail foi preenchido
$resultadoEmailColaborador = '';
if (!empty($emailColaborador)) {
    $resultadoEmailColaborador = enviarTermoPorEmail($caminhoCompleto, $emailColaborador, $nome );
}
